...
palette_gen_c <- function(palette = "main",
                          direction = 1,
                          ...) {
...
scale_fill_biodt <- function(palette = "main",
                             direction = 1,
                             ...) {
  ggplot2::discrete_scale("fill", "biodt",
...
scale_colour_biodt <-
  function(palette = "main",
           direction = 1,
           ...) {
    ggplot2::discrete_scale("colour", "biodt",
                            palette_gen(palette, direction),
                            ...)
  }
...
dummy_df <-
  tibble(
    species = c("sp1", "sp2", "sp3", "sp4", "sp5", "sp6", "sp7", "sp8"),
