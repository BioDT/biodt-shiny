box::use(
  ...
  leaflet[setView, leaflet, leafletOptions, leafletOutput, renderLeaflet, addTiles, addMarkers],
  htmlwidgets[JS],
  waiter[Waiter]
)
...
#' @export
grassland_dynamics_inputmap_server <- function(id, coordinates, tab_grassland_selected, i18n) {
