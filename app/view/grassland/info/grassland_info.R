  ...
  fluidRow(
    ...
    column(
      ...
      tags$div(
        ...
        tags$br(),
        tags$p(i18n$translate("Understand the dynamic interplay of environmental drivers, management regimes, grassland dynamics & biodiversity in a process-based, quantitative and dynamic manner (e.g. how much could the proportion of herbs change by less frequent cutting within one year at humid sites?).")),
        tags$br(),
