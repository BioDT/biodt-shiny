...
ces_ui <- function(id, i18n) {
  ...
  navset_tab(
    ...
    nav_panel(
      title = i18n$translate("Recreation & Biodiversity"),
    ...
    nav_panel(
      title = i18n$translate("Recreation potential"),
    ...
    nav_panel(
      title = i18n$translate("Biodiversity"),
      value = "Biodiversity",
      icon = icon("tree"),
      ces_biodiversity_ui(
        ns("ces_biodiversity"),
  ...
  moduleServer(id, function(input, output, session) {
    ...
    observeEvent(
      ...
      ignoreInit = TRUE,
      {
        ...
        if (
          !ces_selected() &&
            (input$tab == "Recreation & Biodiversity")
