  ...
  fluidRow(
    ...
    column(
      ...
      tags$div(
        ...
        tags$br(),
        tags$p("Understand the dynamic interplay of environmental drivers, management regimes, grassland dynamics & biodiversity in a process-based, quantitative and dynamic manner (e.g. how much could the proportion of herbs change by less frequent cutting within one year at humid sites?)"),
        tags$br(),
        tags$p("Project temporal changes in biodiversity dynamics (e.g. due to climate change or climate extremes) and provide scenario-based (management) options for mitigating undesired effects.")
      )
    ),
    column(
      width = 6,
